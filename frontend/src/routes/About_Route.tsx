...
export default function About() {
  return (
    <>
      <section className="wrapper-dark font-kanit">
        <h1 className="text-3xl text-center text-(--orange-main) py-6">
          About us
        </h1>
        <section className="max-w-3xl mx-auto px-8 py-6 text-center">
        ...
        <section className="bg-(--purple-dark) mx-auto max-w-3xl w-full min-h-64 text-(--orange-main) px-8 py-10">
